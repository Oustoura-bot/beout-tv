      ...
      <section className="mt-12 overflow-hidden rounded-2xl border border-emerald-500/30 bg-ink-800/80 p-6 shadow-glow-sm sm:p-8">
        <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
          ...
          <div className="flex flex-col items-center gap-2">
            <span className="text-xs font-medium uppercase tracking-wider text-emerald-500">كود التطبيق / كلمة السر</span>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          ...
          {!settings?.android_link && !settings?.ios_link && settings?.download_link && (
            <Link 
